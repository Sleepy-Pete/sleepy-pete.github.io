...
interface CarouselOptions {
  autoRotateDelay?: number // milliseconds before auto-rotate starts
  autoRotateInterval?: number // milliseconds between auto-rotations
  projects?: Project[]
}
...
export default ((userOpts?: Partial<CarouselOptions>) => {
  const FeaturedCarousel: QuartzComponent = ({ 
    ...
    return (
      <section class={classNames(displayClass, "featured-carousel-section")}>
        ...
        <div 
          ...
          data-auto-rotate-delay={opts.autoRotateDelay}
        ...
        >
          ...
          <button class="carousel-nav carousel-nav-prev" aria-label="Previous project">
